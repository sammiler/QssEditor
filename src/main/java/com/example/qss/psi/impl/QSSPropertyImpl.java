...
public class QSSPropertyImpl extends ASTWrapperPsiElement implements QSSProperty {
  ...
  @Override
  @Nullable
  public QSSPropertyName getPropertyName() {
    return findChildByClass(QSSPropertyName.class);
  }

  @Override
  @NotNull
  public QSSValueList getValueList() {
    return findNotNullChildByClass(QSSValueList.class);
  }
