...
public class QSSUnexpectedListItemImpl extends ASTWrapperPsiElement implements QSSUnexpectedListItem {

  public QSSUnexpectedListItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QSSVisitor visitor) {
    visitor.visitUnexpectedListItem(this);
  }
