...
public class QSSUniversalSelectorImpl extends ASTWrapperPsiElement implements QSSUniversalSelector {

  public QSSUniversalSelectorImpl(@NotNull ASTNode node) {
    super(node);
  }
