...
public class QSSHashSelectorImpl extends ASTWrapperPsiElement implements QSSHashSelector {

  public QSSHashSelectorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QSSVisitor visitor) {
    visitor.visitHashSelector(this);
  }
