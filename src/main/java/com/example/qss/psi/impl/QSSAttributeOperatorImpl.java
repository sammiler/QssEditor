...
public class QSSAttributeOperatorImpl extends ASTWrapperPsiElement implements QSSAttributeOperator {

  public QSSAttributeOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QSSVisitor visitor) {
    visitor.visitAttributeOperator(this);
  }
