...
public class QSSPseudoElementImpl extends ASTWrapperPsiElement implements QSSPseudoElement {

  public QSSPseudoElementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QSSVisitor visitor) {
    visitor.visitPseudoElement(this);
  }
