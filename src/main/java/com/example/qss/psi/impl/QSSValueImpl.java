...
public class QSSValueImpl extends ASTWrapperPsiElement implements QSSValue {

  public QSSValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public QSSSimpleValue getSimpleValue() {
    return findNotNullChildByClass(QSSSimpleValue.class);
  }
